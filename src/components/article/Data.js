const Data = [
  {
    id: 1,
    sirketAdi: 'GAME AND APPLICATION ACADEMY',
    pozisyonAdi: 'Trainee',
    calismaTarihi: 'NOV 2023',
    devamEdiyor: 'PRESENT',
    konum: 'BURSA',
    aciklama:
  ...
  },
  {
    id: 2,
    sirketAdi: 'PWNLAB.ME',
    pozisyonAdi: 'Content Creator',
    calismaTarihi: 'JUN 2023',
    devamEdiyor: 'PRESENT',
    konum: 'BURSA',
    aciklama:
    ...
    kullanilanlar: ['Snort', 'Cyber Security', 'CyberOps'],
  },
];
